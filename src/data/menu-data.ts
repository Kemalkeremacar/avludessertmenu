...
// Prices synced with "EN GÜNCEL FİYAT" list.
// ---------------------------------------------------------------------------
...
export const menuItems: MenuItem[] = [
  ...
  {
    id: "herbal-tea",
    name: { tr: "Şifalı Bitki Çayları", en: "Herbal Teas" },
    description: {
      tr: "Ihlamur, adaçayı, zencefil, tarçın, papatya, yeşil çay ve daha fazlası.",
      en: "Linden, sage, ginger, cinnamon, chamomile, green tea and more.",
    },
    price: "120 TL",
    category: "tea",
  },
  ...
  {
    id: "cheesecake",
    name: { tr: "Cheescakess", en: "Cheesecakes" },
  ...
  },
  {
    ...
    name: { tr: "Taze Frambuazlı Cheescake", en: "Fresh Raspberry Cheesecake" },
  ...
  },
  {
    ...
    name: { tr: "Taze Limonlu Cheescake", en: "Fresh Lemon Cheesecake" },
    description: { tr: "Taze limonlu cheesecake.", en: "Fresh lemon cheesecake." },
    price: "250 TL",
    category: "desserts",
  },
  {
    id: "karamelize-lotus-cheesecake",
    name: { tr: "Karamelize Lotus Cheescake", en: "Caramelized Lotus Cheesecake" },
    description: { tr: "Karamelize lotus cheesecake.", en: "Caramelized lotus cheesecake." },
    price: "250 TL",
    category: "desserts",
  },
  {
  ...
  {
    id: "elmali-tart",
    name: { tr: "Elmalı Tart", en: "Apple Tart" },
    description: { tr: "Elmalı tart.", en: "Apple tart." },
    price: "220 TL",
    category: "desserts",
  },
  {
